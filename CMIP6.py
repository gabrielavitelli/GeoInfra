...
#HadGem
entrada_hadgem = "C:/Users/gabri/OneDrive/ESTUDOS/GeoInfra/dados/adaptor.esgf_wps.retrieve-1712755790.4155934-28912-10-aa6a2da7-076d-4ed9-9962-4c1a13fc44b2/tas_day_HadGEM3-GC31-MM_ssp585_r1i1p1f3_gn_20500101-20991230_v20200515.nc"
ds_hadgem = xr.open_mfdataset(entrada_hadgem)
recorte=ds_hadgem['tas'].isel(lat=0,lon=0, time=slice(0, 30))
dimensionado = recorte.expand_dims({'lat': [recorte.lat], 'lon': [recorte.lon]})
# cria formato tabela
df = dimensionado.to_dataframe(name='tas')
df_hadgem = df.drop(labels='height', axis=1)
...
# CHIRPS
entrada_chirps="C:/Users/gabri/OneDrive/ESTUDOS/GeoInfra/dados/chirps-v2.0.2024.days_p05.nc"
